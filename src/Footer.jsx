  ...
  return (
    <div>
      ...
      <div className="container-fluid ">
          ...
          <div className="d-flex text-grey  d-flex justify-content-center">
              <h5 className="text-body-secondary"> Created <span className="text-decoration-underline">By Mariami Tsabadze & Zuka Amiridze</span> / </h5> 
    ...
    <nav className=" navbar navbar-expand-lg d-flex mt-4  d-block d-md-none " >
      <div className="container-fluid ">
          ...
          <div className="d-flex text-grey  d-flex justify-content-center">
              <h6 className="text-body-secondary"> Created <span className="text-decoration-underline">By Mariami Tsabadze & Zuka Amiridze</span> / </h6> 
